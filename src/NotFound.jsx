    ...
    <div className="text-center ">
        ...
        <h1 className="mt-4 text-5xl font-semibold tracking-tight text-balance sm:text-7xl text-white">Page not found</h1>
        <p className="mt-6 text-lg font-medium text-pretty sm:text-xl/8 text-white">Sorry, we couldn’t find the page you’re looking for.</p>
