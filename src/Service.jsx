...
export default function Popular() {
  ...
  useEffect(()=>{
    axios.get(`https://api.jikan.moe/v4/anime?order_by=popularity&sort=asc&limit=25&page=${page}`)
  ...
  return (
    <div>
    <h1 className='text-white text-2xl my-5'>Popular Anime</h1>
    ...
    <button onClick={()=>setPage(e => Math.max(e - 1, 1))}
      disabled={page === 1}
    ...
    >
      ...
      Previous</button>
    <span className="text-white text-lg font-medium bg-gray-800 px-4 py-2 rounded-full">page:{page}</span>
